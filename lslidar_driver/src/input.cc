 ...
 */
Input::Input(ros::NodeHandle private_nh, uint16_t port, int packet_size) : private_nh_(private_nh), port_(port),packet_size_(packet_size)
{
...
/** @brief constructor
   ...
   */
InputPCAP::InputPCAP(ros::NodeHandle private_nh, uint16_t port, int packet_size,double packet_rate, std::string filename,
